...
public class SqlLibrary {
	...
	public static Connection GetConnection(String database){
		...
		try {
			...
			JOptionPane.showMessageDialog(null, "You must start your Mysql Server to login.", "Error", JOptionPane.ERROR_MESSAGE, new ImageIcon("icons\\error.png"));
			e.getLocalizedMessage();
			e.printStackTrace();
		}
		return conn;
	...
	public static boolean TestUser(String uname, String pass,String database){
		Connection conn = SqlLibrary.GetConnection(database);
		int count = 0;
		boolean status = false;
		String query = "select * from admin where admin_name = '"+uname+"' and admin_pass = '"+pass+"'";
	...
	public static ArrayList<String> GetRightOfWhere(String stem){
		...
		Connection conn = SqlLibrary.GetConnection("project");
		String query = "SELECT table_name,column_name"+
					   " FROM INFORMATION_SCHEMA.columns"+
	...
	public static ArrayList<ArrayList<Object>> selectTable(String url,String[] flds){
		...
		ResultSet rs = null;
		Connection con = SqlLibrary.GetConnection("project");
		try {
			int j = 1;
